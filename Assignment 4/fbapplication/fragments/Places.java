 ...
 * {@link Places.OnPlacesFragmentInteractionListener} interface
...
public class Places extends Fragment {
    ...
    public static ArrayList<Items> placeItems = new ArrayList<Items>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
        ListView yourListView = (ListView) rootView.findViewById(R.id.listView4);
        ...
        ListAdaptor customAdapter = new ListAdaptor(this.getContext(), R.layout.row, placeItems);
