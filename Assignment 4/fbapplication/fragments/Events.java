 ...
 * {@link Events.OnEventsFragmentInteractionListener} interface
...
public class Events extends Fragment {
    ...
    public static ArrayList<Items> eventItems = new ArrayList<Items>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
        ListView yourListView = (ListView) rootView.findViewById(R.id.listView5);
        ...
        ListAdaptor customAdapter = new ListAdaptor(this.getContext(), R.layout.row, eventItems);
